...
public class CacheConfiguration {
	...
	public JCacheManagerCustomizer cacheManagerCustomizer() {
		return cm -> {
			...
			cm.createCache(com.arte.application.template.domain.Rol.class.getName() + ".operaciones",
					jcacheConfiguration);
			...
			cm.createCache(com.arte.application.template.domain.Operacion.class.getName() + ".roles",
					jcacheConfiguration);
