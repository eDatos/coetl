...
public class UsuarioResource extends AbstractResource {
    ...
    @Timed
    @PreAuthorize("@secChecker.checkUsuarioPermission(authentication)")
    ...
    @PutMapping("/usuarios")
    @Timed
    @PreAuthorize("this.isCurrentUser(#managedUserVM) or @secChecker.checkUsuarioPermission(authentication)")
