package es.gobcan.istac.coetl.aop.logging;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(es.gobcan.istac.coetl.repository..*)" + " || within(es.gobcan.istac.coetl.service..*)" + " || within(es.gobcan.istac.coetl.web.rest..*)")
